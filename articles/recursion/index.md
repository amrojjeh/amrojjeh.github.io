...
The [Fibonacci sequence](https://oeis.org/A000045)<sup>[1](#footnote-1)</sup> is infinite, generating each number by adding the two directly preceding numbers. So, the first few elements, starting from 0, are: 0, 1, 1, 2, 3, 5, 8, 13… which can be rewritten as: 0, 1, (0 + 1), (1 + 1), (2 + 1), (3 + 2), (5 + 3)…
...
1: [https://oeis.org/A000045](https://oeis.org/A000045)